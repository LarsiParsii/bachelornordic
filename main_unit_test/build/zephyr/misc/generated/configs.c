...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_DIS_SETTINGS, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_DIS_STR_MAX, 21);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_DIS_MODEL, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_DIS_MANUF, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_DIS_SERIAL_NUMBER, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_DIS_SERIAL_NUMBER_STR, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_DIS_SW_REV, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_DIS_SW_REV_STR, 1);
